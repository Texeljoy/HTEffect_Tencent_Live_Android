...
public class ThirdBeautyActivity extends MLVBBaseActivity implements View.OnClickListener {
    ...
    private void startPush(int i) {
        ...
        isRenderInit = false;
        if(i == 1){
            mLivePusher = new V2TXLivePusherImpl(this, V2TXLiveMode.TXLiveMode_RTMP);
            ...
            mLivePusher.setObserver(new V2TXLivePusherObserver() {
                ...
                public int onProcessVideoFrame(V2TXLiveDef.V2TXLiveVideoFrame srcFrame, V2TXLiveDef.V2TXLiveVideoFrame dstFrame) {
                    ...
                    if (!isRenderInit) {
                        isRenderInit = HTEffect.shareInstance().initTextureRenderer(srcFrame.width, srcFrame.height,
                            HTRotationEnum.HTRotationClockwise0,
                            isFrontCamera, 5);
                    }
                    dstFrame.texture.textureId = HTEffect.shareInstance().processTexture(srcFrame.texture.textureId);
